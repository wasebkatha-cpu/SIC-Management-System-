...
import { useAppContext, SINDH_DIVISIONS } from '../context/AppContext';
...
export default function ComplaintForm({ onBack }: ComplaintFormProps) {
  const { complaints, addComplaint, publicBodies, readers, getReaderForLocation } = useAppContext();
