          ...
          <table className="w-full text-left text-sm text-neutral-600 dark:text-neutral-200 min-w-[1200px]">
            <thead className="bg-neutral-50 dark:bg-slate-800/90 border-b border-neutral-200 dark:border-emerald-900/40 text-neutral-500 dark:text-white sticky top-0 z-10">
              <tr>
                ...
                <th className="px-4 py-3 font-medium min-w-[220px]">Designated Official</th>
                <th className="px-4 py-3 font-medium min-w-[220px]">Public Body Name</th>
                <th className="px-4 py-3 font-medium min-w-[150px]">Location (Dist/Div)</th>
                <th className="px-4 py-3 font-medium min-w-[100px] text-center">Reader</th>
                <th className="px-4 py-3 font-medium min-w-[300px]">Contact & Other Information</th>
              </tr>
            </thead>
                ...
                filteredOfficials.map((official) => (
                  <tr key={official.id} className="hover:bg-neutral-50 dark:hover:bg-emerald-950/40 transition-colors">
                    ...
                    <td className="px-4 py-4 text-center">
                      <span className="inline-flex items-center justify-center w-6 h-6 rounded-md text-xs font-bold bg-neutral-100 dark:bg-slate-800 text-neutral-700 dark:text-emerald-300 border border-neutral-200 dark:border-emerald-800/50">
                        {official.reader || '-'}
                      </span>
                    </td>
