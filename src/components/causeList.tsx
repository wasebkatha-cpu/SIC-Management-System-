                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                        ...
                        {item.isToday ? (
                          ...
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-neutral-100 text-neutral-500 border border-neutral-200">
